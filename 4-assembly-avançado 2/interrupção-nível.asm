; Exemplo de utilização de interrupções em modo nível (precisa do circuito circuito-teste-interrupções.cir)

; O display conta ao ritmo máximo, **enquanto** o relógio ligado à interrupção 0 estiver a 1

; Exemplo de utilização da diretiva WAIT (precisa do circuito circuito-teste-interrupções.cir)
;
...
;	- teclado, que deteta uma tecla, mas com uma diretiva WAIT, que adormece o processador quando
;	  não se carregam em teclas e não há mais processos executáveis
...
ATRASO	EQU 32000		; atraso para tornar a contagem mais lenta
...
; *********************************************************************************
	...
	MOV	R2, 5		; valor a somar contador (+1 para subir e -1 para descer)
...
espera_tecla:				; neste ciclo espera-se até uma tecla ser premida
	WAIT					; otimização do YIELD (adormece o processador se não houver mais processos executáveis)

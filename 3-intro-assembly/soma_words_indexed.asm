...
soma:
	...
	PLACE	0
inicio:
	MOV	R1, lista	     ; primeiro elemento (base fixa) da lista
     MOV  R0, 0          ; índice para acesso à lista (a somar à base)
	MOV	R4, size	     ; tamanho da lista
     MOV  R2, 0          ; inicializa soma
loop:
	MOV	R3, [R1+R0]	; próximo elemento da lista
	ADD	R2, R3	     ; acumula elemento na soma
	ADD	R0, 2	     ; índice para próximo elemento (+2)
